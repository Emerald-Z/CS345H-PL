...
valueToInt (TupleVal _) = Left "Type error: expected integer, got tuple"
...
valueToBool (TupleVal _) = Left "Type error: expected boolean, got tuple"
...
valueToString (TupleVal _) = Left "Type error: expected string, got tuple"

valueToTuple :: Value -> Either String [Value]
valueToTuple (TupleVal ts) = Right ts
